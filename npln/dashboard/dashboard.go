...
import (
	...
	"github.com/NextendoNetwork/splatoon-3/npln/services/matchmaking"
...
func (d *Dashboard) Handler() http.Handler {
	...
	// /healthz is what the NEX game servers expose and what a compose healthcheck
	// or load balancer is already configured to hit; /api/health is kept because
	// this server shipped with it.
